  ...
  return (
    <div className="min-h-screen bg-[#F7F3EA] text-[#4E3B2A] overflow-x-hidden">
      <header className="sticky top-0 z-50 bg-[#D9C3A3]/98 backdrop-blur border-b border-[#B78B5A]/25 shadow-sm">
        <nav className="max-w-6xl mx-auto px-4 md:px-6 h-20 md:h-28 flex items-center justify-between">
          ...
          <button
            ...
            className="md:hidden flex items-center justify-center w-11 h-11 rounded-2xl border border-[#7A5530]/15 bg-[#7E9F00] shadow-sm hover:bg-[#6F8E00] transition shrink-0"
      ...
      >
        ...
        >
          <div className="flex items-center justify-between px-5 py-4 border-b border-[#B78B5A]/20">
          ...
          <div className="px-5 py-5 flex flex-col gap-5 font-medium text-base">
      ...
      <section id="inicio" className="px-5 md:px-6 py-12 md:py-28">
        <div className="max-w-6xl mx-auto grid md:grid-cols-2 gap-8 md:gap-10 items-center">
          <div>
            <p className="uppercase tracking-[0.16em] md:tracking-[0.25em] text-xs md:text-sm text-[#7E9F00] mb-4 font-semibold leading-6">
              {t.subtitulo}
            </p>

            <h2 className="text-4xl sm:text-[2.8rem] md:text-6xl font-bold leading-[1.05] md:leading-tight mb-5 md:mb-6">
              {t.titulo}
            </h2>
            ...
            <div className="flex flex-col sm:flex-row gap-4 sm:gap-4">
              <a
                href="#puestos"
                className="w-full sm:w-auto text-center px-5 md:px-6 py-3 rounded-2xl bg-[#B78B5A] text-white font-semibold text-base md:text-lg hover:opacity-90 transition"
              >
                {t.verPuestos}
              </a>
              ...
              <a
                href="#contacto"
                className="w-full sm:w-auto text-center px-5 md:px-6 py-3 rounded-2xl border border-[#B78B5A] text-[#4E3B2A] font-semibold text-base md:text-lg hover:bg-[#B78B5A] hover:text-white transition"
              >
                {t.contactar}
              </a>
            </div>
          ...
          <img
            ...
            className="w-full h-[240px] sm:h-[300px] md:h-[420px] rounded-3xl object-cover shadow-lg"
          />
        </div>
      </section>

      <section id="nosotros" className="px-5 md:px-6 py-14 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-5 md:mb-6">
            {t.quienesSomos}
          </h3>
      ...
      <section id="productos" className="px-5 md:px-6 py-14 md:py-20">
        <div className="max-w-6xl mx-auto">
          <h3 className="text-3xl md:text-4xl font-bold mb-4">{t.nuestrosProductos}</h3>
          <p className="text-[#4E3B2A]/70 text-base md:text-lg mb-8 md:mb-10">
            {t.productosTexto}
          </p>
          ...
          <div className="grid sm:grid-cols-2 md:grid-cols-3 gap-5 md:gap-6">
            {productos[lang].map((producto, index) => (
              <div
                key={index}
                className="bg-white rounded-3xl p-5 md:p-6 shadow-sm border border-[#B78B5A]/20"
              >
      ...
      <section id="puestos" className="px-5 md:px-6 py-14 md:py-20 bg-white">
        <div className="max-w-6xl mx-auto">
            ...
            {puestos.map((puesto, index) => (
              ...
              >
                ...
                <div className="p-5 md:p-6">
                  ...
                  <p className="text-[#4E3B2A]/75 text-base md:text-lg mb-5 leading-8">
                  ...
                  <div className="flex gap-3">
                    <a
                      ...
                      target="_blank"
                      rel="noreferrer"
                      className="flex-1 text-center px-4 md:px-5 py-3 rounded-2xl bg-[#B78B5A] text-white font-semibold text-base md:text-lg hover:opacity-90 transition"
                    >
                      {t.verUbicacion}
                    </a>
                    ...
                    <Link
                      to={puesto.rutaCarta}
                      className="flex-1 text-center px-4 md:px-5 py-3 rounded-2xl bg-[#7E9F00] text-white font-semibold text-base md:text-lg hover:bg-[#6F8E00] transition"
                    >
                      {t.verCarta}
                    </Link>
                  </div>
      ...
      <section id="contacto" className="px-5 md:px-6 py-14 md:py-20 bg-white">
        <div className="max-w-3xl mx-auto text-center">
          <h3 className="text-3xl md:text-4xl font-bold mb-4">{t.contactoTitulo}</h3>
          <p className="text-[#4E3B2A]/70 text-base md:text-lg mb-8">
            {t.contactoTexto}
          </p>
          ...
          <div className="grid gap-4">
            <a
              href="tel:617883822"
              className="p-4 md:p-5 rounded-2xl bg-[#F7F3EA] border border-[#B78B5A]/20 block hover:opacity-90 transition text-base md:text-lg"
            >
